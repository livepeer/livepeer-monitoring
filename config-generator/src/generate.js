...
function generate() {
  ...
  const argv = yargs
    ...
    .options({
      ...
      "prometheus-longterm": {
        describe:
          "enables longterm storage via any prometheus compatible remote storage",
        type: "boolean",
      },
      ...
      "prometheus-retention-size": {
        describe:
          "[EXPERIMENTAL] The maximum number of bytes of storage blocks to retain. The oldest data will be removed first. Defaults to 0 or disabled. This flag is experimental and may change in future releases",
        default: "0",
        type: "string",
      },
      ...
      "prometheus-kafka-monitor-username": {
        describe: "Username/API key for accessing kafka cluster metrics",
        default: "",
        type: "string",
      },
      "prometheus-kafka-monitor-password": {
        describe: "Password/API secret for accessing kafka cluster metrics",
        default: "",
        type: "string",
      },
      "prometheus-kafka-monitor-resources": {
        describe:
          "comma-separated list of resources/clusters to be scraping for metrics",
        default: "",
        type: "string",
      },
      "cadvisor-port": {
      ...
      "alert-namespace": {
        describe:
          "identifier to include in alerts title and namespace all alerts sent",
        default: "",
        type: "string",
      },
      "discord-webhook": {
      ...
      "grafana-alerts": {
        describe:
          "enables grafana alerts to hook up to the prometheus alertmanager",
        type: "boolean",
      },
      "loki-enabled": {
  ...
  saveYaml(
    "/etc/prometheus",
    "rules.yml",
    getRules(argv.alertGroups, argv.alertNamespace)
  );
  saveYaml("/etc/prometheus", "prometheus.yml", promConfig);
  saveYaml(
    "/etc/grafana/provisioning/notifiers",
    "generated_notifiers.yml",
    grafanaNotificationChannelsConfig(argv)
  );
  fs.writeFileSync(
...
function prometheusConfig(params) {
  ...
  if (params && params.prometheusKafkaMonitorEnabled) {
    obj.scrape_configs.push({
      job_name: "Confluent Cloud kafka metrics",
      scrape_interval: "1m",
      scrape_timeout: "1m",
      honor_timestamps: true,
      static_configs: [{ targets: ["api.telemetry.confluent.cloud"] }],
      scheme: "https",
      basic_auth: {
        username: params.prometheusKafkaMonitorUsername,
        password: params.prometheusKafkaMonitorPassword,
      },
    ...
    rules: [
      {
        ...
        annotations: {
          ...
          description:
            "The current broadcasting deposit has fallen below 0.2 ETH",
        },
        labels: {
          severity: "page",
        },
      },
      {
        ...
        annotations: {
          ...
          description:
            "The deposit is critically low and is now below 0.5 ETH, replenish your balance or your reserve will be used soon",
        },
        labels: {
          severity: "high",
        },
      },
      {
        ...
        annotations: {
          ...
          description:
            "Deposit has been depleted, winning tickets are now being redeemed from your reserve. Replenish your broadcasting funds if you wish to continue transcoding",
        },
        labels: {
          severity: "critical",
        },
    ...
    rules: [
      {
        ...
        annotations: {
          ...
          description:
            "The 1m average % of HTTP push requests that completed in real-time or faster is lower than 99%",
        },
        labels: {
          severity: "low",
        },
    ...
    rules: [
      {
        ...
        annotations: {
          ...
          description:
            "The 10m average % of HTTP push requests that completed in real-time or faster is lower than 90%",
        },
        labels: {
          severity: "critical",
        },
    ...
    rules: [
      {
        ...
        annotations: {
          ...
          description:
            "The success rate for instance {{ $labels.instance }} has dropped below 80%",
        },
        labels: {
          severity: "page",
        },
